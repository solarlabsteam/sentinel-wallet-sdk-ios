...
struct Sentinel_Node_V3_Node: Sendable {
...
extension Sentinel_Node_V3_Node: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".Node"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}address\0\u{3}gigabyte_prices\0\u{3}hourly_prices\0\u{3}remote_addrs\0\u{3}inactive_at\0\u{1}status\0\u{3}status_at\0")
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 5: try { try decoder.decodeSingularMessageField(value: &self._inactiveAt) }()
  ...
  static func ==(lhs: Sentinel_Node_V3_Node, rhs: Sentinel_Node_V3_Node) -> Bool {
