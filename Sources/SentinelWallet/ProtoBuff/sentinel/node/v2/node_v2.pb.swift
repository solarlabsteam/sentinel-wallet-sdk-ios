...
struct Sentinel_Node_V2_Node: Sendable {
...
extension Sentinel_Node_V2_Node: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}address\0\u{3}gigabyte_prices\0\u{3}hourly_prices\0\u{3}remote_url\0\u{3}inactive_at\0\u{1}status\0\u{3}status_at\0")
