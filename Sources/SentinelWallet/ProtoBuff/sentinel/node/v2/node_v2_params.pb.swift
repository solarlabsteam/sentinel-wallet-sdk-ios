...
struct Sentinel_Node_V2_Params: Sendable {
...
extension Sentinel_Node_V2_Params: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}deposit\0\u{3}active_duration\0\u{3}max_gigabyte_prices\0\u{3}min_gigabyte_prices\0\u{3}max_hourly_prices\0\u{3}min_hourly_prices\0\u{3}max_subscription_gigabytes\0\u{3}min_subscription_gigabytes\0\u{3}max_subscription_hours\0\u{3}min_subscription_hours\0\u{3}staking_share\0")
