...
struct Sentinel_Session_V2_Session: Sendable {
...
extension Sentinel_Session_V2_Session: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}id\0\u{3}subscription_id\0\u{3}node_address\0\u{1}address\0\u{1}bandwidth\0\u{1}duration\0\u{3}inactive_at\0\u{1}status\0\u{3}status_at\0")
