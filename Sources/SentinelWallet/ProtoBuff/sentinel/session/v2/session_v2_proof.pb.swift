...
struct Sentinel_Session_V2_Proof: Sendable {
...
extension Sentinel_Session_V2_Proof: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".Proof"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}id\0\u{1}bandwidth\0\u{1}duration\0")
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularMessageField(value: &self._bandwidth) }()
  ...
  static func ==(lhs: Sentinel_Session_V2_Proof, rhs: Sentinel_Session_V2_Proof) -> Bool {
