...
struct Sentinel_Session_V1_Session: Sendable {
...
extension Sentinel_Session_V1_Session: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}id\0\u{1}subscription\0\u{1}node\0\u{1}address\0\u{1}duration\0\u{1}bandwidth\0\u{1}status\0\u{3}status_at\0")
