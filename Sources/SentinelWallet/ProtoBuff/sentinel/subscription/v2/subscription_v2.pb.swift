...
enum Sentinel_Subscription_V2_SubscriptionType: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  static let allCases: [Sentinel_Subscription_V2_SubscriptionType] = [
    .typeUnspecified,
    .typeNode,
    .typePlan,
  ]
...
struct Sentinel_Subscription_V2_BaseSubscription: Sendable {
...
struct Sentinel_Subscription_V2_NodeSubscription: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Sentinel_Subscription_V2_PlanSubscription: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Sentinel_Subscription_V2_SubscriptionType: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0TYPE_UNSPECIFIED\0\u{1}TYPE_NODE\0\u{1}TYPE_PLAN\0")
}
...
extension Sentinel_Subscription_V2_BaseSubscription: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}id\0\u{1}address\0\u{3}inactive_at\0\u{1}status\0\u{3}status_at\0")
...
extension Sentinel_Subscription_V2_NodeSubscription: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}base\0\u{3}node_address\0\u{1}gigabytes\0\u{1}hours\0\u{1}deposit\0")
...
extension Sentinel_Subscription_V2_PlanSubscription: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}base\0\u{3}plan_id\0\u{1}denom\0")
