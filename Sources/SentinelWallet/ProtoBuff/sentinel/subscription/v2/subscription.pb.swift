...
public struct Sentinel_Subscription_V2_BaseSubscription {
...
public struct Sentinel_Subscription_V2_NodeSubscription {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    
    public var base: Sentinel_Subscription_V2_BaseSubscription {
    ...
    public var nodeAddress: String = String()
    
    public var gigabytes: Int64 = 0
    
    public var hours: Int64 = 0
...
public struct Sentinel_Subscription_V2_PlanSubscription {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
...
extension Sentinel_Subscription_V2_BaseSubscription: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    public static let protoMessageName: String = _protobuf_package + ".BaseSubscription"
    ...
    public static func ==(lhs: Sentinel_Subscription_V2_BaseSubscription, rhs: Sentinel_Subscription_V2_BaseSubscription) -> Bool {
...
extension Sentinel_Subscription_V2_NodeSubscription: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    public static let protoMessageName: String = _protobuf_package + ".NodeSubscription"
    public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
        1: .same(proto: "base"),
    ...
    public static func ==(lhs: Sentinel_Subscription_V2_NodeSubscription, rhs: Sentinel_Subscription_V2_NodeSubscription) -> Bool {
...
extension Sentinel_Subscription_V2_PlanSubscription: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    public static let protoMessageName: String = _protobuf_package + ".PlanSubscription"
    public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
        1: .same(proto: "base"),
    ...
    public static func ==(lhs: Sentinel_Subscription_V2_PlanSubscription, rhs: Sentinel_Subscription_V2_PlanSubscription) -> Bool {
        if lhs._base != rhs._base {return false}
