...
struct Sentinel_Subscription_V1_Subscription: Sendable {
...
extension Sentinel_Subscription_V1_Subscription: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}id\0\u{1}owner\0\u{1}node\0\u{1}price\0\u{1}deposit\0\u{1}plan\0\u{1}denom\0\u{1}expiry\0\u{1}free\0\u{1}status\0\u{3}status_at\0")
