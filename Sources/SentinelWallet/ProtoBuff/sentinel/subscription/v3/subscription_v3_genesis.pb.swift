...
struct Sentinel_Subscription_V3_GenesisState: Sendable {
...
extension Sentinel_Subscription_V3_GenesisState: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".GenesisState"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}allocations\0\u{1}subscriptions\0\u{1}params\0")
  ...
  static func ==(lhs: Sentinel_Subscription_V3_GenesisState, rhs: Sentinel_Subscription_V3_GenesisState) -> Bool {
