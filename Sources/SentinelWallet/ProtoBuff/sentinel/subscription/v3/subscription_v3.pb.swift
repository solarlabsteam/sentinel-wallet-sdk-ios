...
struct Sentinel_Subscription_V3_Subscription: Sendable {
...
extension Sentinel_Subscription_V3_Subscription: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}id\0\u{3}acc_address\0\u{3}plan_id\0\u{1}price\0\u{3}renewal_price_policy\0\u{1}status\0\u{3}inactive_at\0\u{3}start_at\0\u{3}status_at\0")
  ...
  static func ==(lhs: Sentinel_Subscription_V3_Subscription, rhs: Sentinel_Subscription_V3_Subscription) -> Bool {
