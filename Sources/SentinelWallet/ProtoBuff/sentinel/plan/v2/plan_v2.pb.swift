...
struct Sentinel_Plan_V2_Plan: Sendable {
...
extension Sentinel_Plan_V2_Plan: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}id\0\u{3}provider_address\0\u{1}duration\0\u{1}gigabytes\0\u{1}prices\0\u{1}status\0\u{3}status_at\0")
