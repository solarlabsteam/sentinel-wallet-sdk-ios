...
struct Sentinel_Plan_V1_Plan: Sendable {
...
extension Sentinel_Plan_V1_Plan: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}id\0\u{1}provider\0\u{1}price\0\u{1}validity\0\u{1}bytes\0\u{1}status\0\u{3}status_at\0")
