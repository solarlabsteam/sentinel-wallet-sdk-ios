...
struct Sentinel_Provider_V2_Provider: Sendable {
...
extension Sentinel_Provider_V2_Provider: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}address\0\u{1}name\0\u{1}identity\0\u{1}website\0\u{1}description\0\u{1}status\0\u{3}status_at\0")
