...
// Source: sentinel/provider/v3/params.proto
//
...
struct Sentinel_Provider_V3_Params: Sendable {
...
extension Sentinel_Provider_V3_Params: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".Params"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}deposit\0")
  ...
  static func ==(lhs: Sentinel_Provider_V3_Params, rhs: Sentinel_Provider_V3_Params) -> Bool {
